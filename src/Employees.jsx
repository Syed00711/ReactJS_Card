...
const transformedTeam = employees.map( (employee) => employee.id === parseInt(event.currentTarget.id)
...
<div className="card-collections">
{
 ...
 <div className="card-body"><h5 className="card-title">Full Name: {employee.fullName}</h5></div>
 </div>)
})
}
</div>
